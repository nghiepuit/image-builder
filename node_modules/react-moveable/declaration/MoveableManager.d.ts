...
declare const ControlBoxElement: {
    new (props: Readonly<import("@daybrush/utils").IObject<any>>): {
        element: HTMLElement;
        ...
        context: any;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: Readonly<import("@daybrush/utils").IObject<any>>) => {} | Pick<{}, K> | null) | Pick<{}, K> | null, callback?: (() => void) | undefined): void;
        forceUpdate(callBack?: (() => void) | undefined): void;
        readonly props: Readonly<import("@daybrush/utils").IObject<any>> & Readonly<{
            children?: React.ReactNode;
        }>;
        state: Readonly<{}>;
        refs: {
    ...
    new (props: import("@daybrush/utils").IObject<any>, context?: any): {
        element: HTMLElement;
        injectResult: import("css-styled").InjectResult | null;
        render(): React.DOMElement<{
            children?: React.ReactNode;
