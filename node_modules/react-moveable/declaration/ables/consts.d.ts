...
export declare const MOVEABLE_ABLES: readonly [{
    ...
    dragControlCondition: typeof import("../groupUtils").directionCondition;
    ...
    dragGroupControlCondition: typeof import("../groupUtils").directionCondition;
    ...
    dragStart(moveable: import("../MoveableManager").default<{}, {}>, { datas, clientX, clientY, inputEvent }: any): void;
    drag(moveable: import("../MoveableManager").default<{}, {}>, { datas }: any): void;
    dragEnd(moveable: import("../MoveableManager").default<import("..").DragAreaProps, {}>, e: any): void;
    dragGroupStart(moveable: import("../MoveableGroup").default, e: any): void;
    dragGroup(moveable: import("../MoveableGroup").default, e: any): void;
    dragGroupEnd(moveable: import("../MoveableGroup").default, e: any): void;
}, {
    name: string;
    props: {
