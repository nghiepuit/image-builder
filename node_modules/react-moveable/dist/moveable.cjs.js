...
function isBoundRotate(relativePoses, boundRect, rad) {
  ...
  var nextPos1 = matrix.rotate(pos1, rad);
  var nextPos2 = matrix.rotate(pos2, rad);
  var nextPos3 = matrix.rotate(pos3, rad);
  var nextPos4 = matrix.rotate(pos4, rad);
...
function checkSnapRotate(moveable, rect, origin, rotation) {
  ...
  var relativePos1 = matrix.minus(pos1, origin);
  var relativePos2 = matrix.minus(pos2, origin);
  var relativePos3 = matrix.minus(pos3, origin);
  var relativePos4 = matrix.minus(pos4, origin);
  var relativePoses = [relativePos1, relativePos2, relativePos3, relativePos4];
  var nextPos1 = matrix.rotate(relativePos1, rad);
  var nextPos2 = matrix.rotate(relativePos2, rad);
  var nextPos3 = matrix.rotate(relativePos3, rad);
  var nextPos4 = matrix.rotate(relativePos4, rad);
  ...
  var _loop_1 = function (i) {
    var _a = canBounds[i],
        ...
        boundPos = _a[1],
        index = _a[2];
    var relativeRad1 = matrix.getRad([0, 0], vec);
...
var Snappable = {
  ...
  render: function (moveable, React) {
    ...
    return flat(elementHorizontalGroup.map(function (elementGuidelines, i) {
    ...
    })).concat(flat(elementVerticalGroup.map(function (elementGuidelines, i) {
      return elementGuidelines.map(function (_a, j) {
        var pos = _a.pos,
            size = _a.size;
...
var Rotatable = {
  ...
  dragControlStart: function (moveable, e) {
    ...
    if (pinchFlag || parentFlag) {
      ...
      datas.beforeInfo = {
        origin: matrix.plus([left, top], beforeOrigin)
      };
      datas.afterInfo = {
        origin: matrix.plus([left, top], origin)
      };
