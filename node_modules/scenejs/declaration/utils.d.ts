...
export declare function getType(value: any): "boolean" | "symbol" | "undefined" | "object" | "function" | "array" | "property" | "value";
...
export declare function setPlayCSS(item: Scene | SceneItem, isActivate: boolean): void;
...
export declare function exportCSS(id: number | string, css: string): void;
...
export declare function addAnimationEvent(item: Scene | SceneItem, el: Element): void;
